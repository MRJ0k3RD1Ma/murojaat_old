 ...
 */
class AppealRegisterMyHasSearch extends AppealRegister
{
    ...
    public function search($params)
    {
        ...
        $query = AppealRegister::find()
            ...
            ->andWhere('appeal_register.ijrochi_id = '.$user->id.' or appeal_register.rahbar_id = '.$user->id)
            ->innerJoin('appeal','appeal.id=appeal_register.appeal_id')
            ->innerJoin('appeal_answer','appeal_answer.appeal_id=appeal.id')->orderBy(['appeal_answer.created'=>SORT_DESC,'appeal_register.status'=>SORT_ASC,'appeal_register.deadtime'=>SORT_ASC]);
