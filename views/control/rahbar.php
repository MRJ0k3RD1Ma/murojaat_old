...
/* @var $res Array */
/* @var $name string */
$this->title = "Раҳбарлар кесимида мурожаатлар ҳолати";
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                Раҳбарларга ижрога ўтган мурожаатлар рўйхати рўйхати
                            </h3>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <?php $n=0; foreach ($model as $item): $n++;?>
                                        <tr>
                                            <td><?= $n;?></td>
                                            <td><?= $item->name?></td>
                                            <td class="text-center"><a href="<?= Yii::$app->urlManager->createUrl(['/control/listrahbar','AppealRegisterSearch[ijrochi_id]'=>$item->id])?>"><?= $res[$item->id][0]?></a></td>
                                            <td class="text-center"><a href="<?= Yii::$app->urlManager->createUrl(['/control/listrahbar','AppealRegisterSearch[ijrochi_id]'=>$item->id,'AppealRegisterSearch[sts]'=>2])?>"><?= $res[$item->id][1]?></a></td>
                                            <td class="text-center"><a href="<?= Yii::$app->urlManager->createUrl(['/control/listrahbar','AppealRegisterSearch[ijrochi_id]'=>$item->id,'AppealRegisterSearch[sts]'=>3])?>"><?= $res[$item->id][2]?></a></td>
                                            <td class="text-center"><a href="<?= Yii::$app->urlManager->createUrl(['/control/listrahbar','AppealRegisterSearch[ijrochi_id]'=>$item->id,'AppealRegisterSearch[sts]'=>4])?>"><?= $res[$item->id][3]?></a></td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
                                </table>
