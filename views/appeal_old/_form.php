        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?= $form->field($model, 'nation_id')->dropDownList(\yii\helpers\ArrayHelper::map(\app\models\Nation::find()->all(),'id','name'),['prompt'=>'Миллатини танланг']) ?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <?= $form->field($register,'deadline')->dropDownList([15=>15,30=>30,60=>60])?>
                                </div>
                                <div class="col-md-6">
